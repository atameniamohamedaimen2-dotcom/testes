...
import { assessments, getAssessmentById } from "../assessments/registry";
...
export default function AssessmentInfoPage() {
  ...
  if (assessment.id === "iq") return <Navigate to="/" replace />;
  ...
  const defaultTitle =
    assessment.id === "mbti"
      ...
      : assessment.id === "big-five"
        ...
        : `${assessment.name} Information | ${brandName}`;
  const defaultDescription =
    assessment.id === "mbti"
      ...
      : assessment.id === "big-five"
        ...
        : `${assessment.name} information page. Content and questions will be added later.`;
  const infoBaseKey = `assessments.info.${assessment.id}`;
  const title = (get(`${infoBaseKey}.helmet.title`) as string | undefined) ?? defaultTitle;
  const description = (get(`${infoBaseKey}.helmet.description`) as string | undefined) ?? defaultDescription;
    ...
    return (
      <>
        ...
        <section className={homeStyles.hero}>
          ...
          <p className={homeStyles.subtitle}>{description}</p>

          <div className={homeStyles.badges} aria-label="Highlights">
            {(((get(`${infoBaseKey}.badges`) as string[] | undefined) ?? mbtiBadges) as string[]).map((b) => (
              <span key={b} className={homeStyles.badge}>
                {b}
              </span>
            ))}
          </div>
          ...
          <div className={homeStyles.cta}>
            <h2 className={homeStyles.ctaTitle}>{i18nStr(`${infoBaseKey}.cta.title`, "Start with your type assessment")}</h2>
            <p className={homeStyles.ctaText}>
              {i18nStr(`${infoBaseKey}.cta.text`, "20 questions • 4 dichotomies • instant profile")}
            </p>
            <Link to={startHref} className={homeStyles.ctaButton}>
              {i18nStr(`${infoBaseKey}.cta.button`, "🧪 Take the MBTI Assessment")}
            </Link>
          </div>
        </section>

        <section className={homeStyles.section}>
          <h2 className={homeStyles.sectionTitle}>Is personality fixed or fluid?</h2>
          <div className={homeStyles.snippet} role="note" aria-label="Key takeaway">
            While core preferences tend to remain stable through adulthood, understanding your type helps you develop
            weaker cognitive functions and adapt behaviors without changing your essential nature.
          </div>

          <div className={homeStyles.cards}>
            <div className={homeStyles.card}>
              <div className={homeStyles.cardTitle}>Cognitive Functions</div>
              <div className={homeStyles.cardText}>
                MBTI is based on 8 cognitive functions (ways of processing information) stacked in a specific order for
                each type. Your dominant and auxiliary functions shape how you see the world and make decisions.
              </div>
            </div>
            <div className={homeStyles.card}>
              <div className={homeStyles.cardTitle}>What to explore first</div>
              <div className={homeStyles.cardText}>
                Understanding your energy direction (E/I), information gathering (S/N), decision making (T/F), and
                lifestyle approach (J/P) creates immediate clarity about natural strengths and blind spots.
              </div>
            </div>
          </div>
        </section>
        ...
        <section className={homeStyles.section}>
          <h2 className={homeStyles.sectionTitle}>The 4 Dichotomies Explained</h2>
          <div className={homeStyles.grid} aria-label="Dichotomies">
            {mbtiDichotomies.map((d, idx) => (
              <article key={d.title} className={homeStyles.methodCard}>
                <div className={homeStyles.methodIcon} aria-hidden="true">
                  {mbtiDichotomyIcons[idx] ?? "🧭"}
                </div>
                <div className={homeStyles.methodTitle}>{d.title}</div>
                <div className={homeStyles.methodDesc}>
                  <div>
                    <strong>{d.leftTitle}:</strong> {d.leftText}
                  </div>
                  <div>
                    <strong>{d.rightTitle}:</strong> {d.rightText}
                  </div>
                </div>
              </article>
            ))}
        ...
        <section className={homeStyles.section}>
          <h2 className={homeStyles.sectionTitle}>The 16 Personality Types at a Glance</h2>
          <div className={homeStyles.grid} aria-label="Type groups">
            {mbtiTypeGroups.map((g) => (
              <div key={g.title} className={homeStyles.listCard}>
                <div className={homeStyles.cardTitle}>{g.title}</div>
        ...
        <section className={homeStyles.section}>
          <h2 className={homeStyles.sectionTitle}>15 Ways to Apply Your Type Knowledge</h2>
          <div className={homeStyles.grid} aria-label="Applications">
            {mbtiApplications.map((s, idx) => (
              <article key={s.title} className={homeStyles.methodCard}>
                <div className={homeStyles.methodIcon} aria-hidden="true">
                  {mbtiApplicationIcons[idx] ?? "🧩"}
                </div>
                <div className={homeStyles.methodTitle}>{s.title}</div>
                <div className={homeStyles.methodDesc}>{s.text}</div>
                <div className={homeStyles.methodBenefits}>
        ...
        <section className={homeStyles.section}>
          <h2 className={homeStyles.sectionTitle}>Extra Checklist (Simple, High-Impact)</h2>
          <div className={homeStyles.listCard}>
            <ul className={homeStyles.list}>
              {mbtiChecklist.map((c) => (
                <li key={c}>{c}</li>
              ))}
            </ul>
            <Link to={startHref} className={homeStyles.secondaryButton}>
              Start the test →
            </Link>
          </div>
        </section>
        ...
        <section className={homeStyles.section}>
          <h2 className={homeStyles.sectionTitle}>Other assessments</h2>
          <div className={homeStyles.grid} aria-label="Other assessments">
            {assessments
              ...
              .map((a) => (
                ...
                >
                  ...
                  <div className={homeStyles.methodTitle}>{a.name}</div>
                  <div className={homeStyles.methodDesc}>Info page → start test</div>
                </Link>
              ))}
          </div>
        </section>
    ...
    return (
      <>
        ...
        <section className={homeStyles.hero}>
          ...
          <div className={homeStyles.badges} aria-label="Highlights">
            {(((get(`${infoBaseKey}.badges`) as string[] | undefined) ?? bigFiveBadges) as string[]).map((b) => (
              <span key={b} className={homeStyles.badge}>
                {b}
              </span>
            ))}
          ...
          <div className={homeStyles.cta}>
            <h2 className={homeStyles.ctaTitle}>{i18nStr(`${infoBaseKey}.cta.title`, "Start with your trait profile")}</h2>
            <p className={homeStyles.ctaText}>
              {i18nStr(`${infoBaseKey}.cta.text`, "20 questions • 5 dimensions • percentile scoring • instant report")}
            </p>
            <Link to={startHref} className={homeStyles.ctaButton}>
              {i18nStr(`${infoBaseKey}.cta.button`, "🧪 Take the Big Five Assessment")}
            </Link>
          </div>
        </section>

        <section className={homeStyles.section}>
          <h2 className={homeStyles.sectionTitle}>Can personality change?</h2>
          <div className={homeStyles.snippet} role="note" aria-label="Key takeaway">
            The Big Five traits are relatively stable after age 30, but deliberate intervention—especially in therapy,
            coaching, or major life transitions—can shift your standing by 10–20 percentile points over time.
          </div>

          <div className={homeStyles.cards}>
            <div className={homeStyles.card}>
              <div className={homeStyles.cardTitle}>Trait vs. Type</div>
              <div className={homeStyles.cardText}>
                Unlike MBTI types (either/or), Big Five traits are continuous dimensions (spectrums). You can be high,
                average, or low on each trait, creating many unique combinations.
              </div>
            </div>
            <div className={homeStyles.card}>
              <div className={homeStyles.cardTitle}>What predicts success</div>
              <div className={homeStyles.cardText}>
                Meta-analyses show Conscientiousness predicts job performance strongly; Emotional Stability (low
                Neuroticism) predicts relationship satisfaction; Openness predicts creativity.
              </div>
            </div>
          </div>
        </section>
        ...
        <section className={homeStyles.section}>
          <h2 className={homeStyles.sectionTitle}>The Five Dimensions Explained</h2>
          <div className={homeStyles.grid} aria-label="Dimensions">
            {bigFiveDimensions.map((d) => (
              <div key={d.title} className={homeStyles.listCard}>
                <div className={homeStyles.cardTitle}>
                  <span aria-hidden="true">{d.icon}</span> {d.title}
                </div>
                <div className={homeStyles.cardText}>{d.summary}</div>
                <ul className={homeStyles.list}>
                  <li>
                    <strong>High:</strong> {d.high}
                  </li>
                  <li>
                    <strong>Low:</strong> {d.low}
                  </li>
                  <li>
                    <strong>Facets:</strong> {d.facets}
                  </li>
                </ul>
              </div>
            ))}
        ...
        <section className={homeStyles.section}>
          <h2 className={homeStyles.sectionTitle}>15 Evidence-Based Applications of Your Big Five Profile</h2>
          <div className={homeStyles.grid} aria-label="Applications">
            {bigFiveApplications.map((s, idx) => (
              <article key={s.title} className={homeStyles.methodCard}>
                <div className={homeStyles.methodIcon} aria-hidden="true">
                  {mbtiApplicationIcons[idx] ?? "🧩"}
                </div>
        ...
        <section className={homeStyles.section}>
          <h2 className={homeStyles.sectionTitle}>Extra Checklist (Precision & Application)</h2>
          <div className={homeStyles.listCard}>
            <ul className={homeStyles.list}>
              {bigFiveChecklist.map((c) => (
                <li key={c}>{c}</li>
              ))}
            </ul>
            <Link to={startHref} className={homeStyles.secondaryButton}>
    ...
    return (
      <>
        ...
        <section className={homeStyles.hero}>
          ...
          <div className={homeStyles.badges} aria-label="Highlights">
            {(((get(`${infoBaseKey}.badges`) as string[] | undefined) ?? discBadges) as string[]).map((b) => (
              <span key={b} className={homeStyles.badge}>
                {b}
              </span>
            ))}
          ...
          <div className={homeStyles.cta}>
            <h2 className={homeStyles.ctaTitle}>
              {i18nStr(`${infoBaseKey}.cta.title`, "Start with your behavioral profile")}
            </h2>
            <p className={homeStyles.ctaText}>
              {i18nStr(`${infoBaseKey}.cta.text`, "16 questions • 4 quadrants • priority stacking • instant report")}
            </p>
            <Link to={startHref} className={homeStyles.ctaButton}>
              {i18nStr(`${infoBaseKey}.cta.button`, "🧪 Take the DISC Assessment")}
            </Link>
          </div>
        </section>

        <section className={homeStyles.section}>
          <h2 className={homeStyles.sectionTitle}>Is behavior destiny?</h2>
          <div className={homeStyles.snippet} role="note" aria-label="Key takeaway">
            DISC measures natural tendencies (how you prefer to act) and adapted behaviors (how you act under pressure).
            Behaviors can be consciously modified to match context without changing who you are.
          </div>

          <div className={homeStyles.cards}>
            <div className={homeStyles.card}>
              <div className={homeStyles.cardTitle}>Observable vs. Internal</div>
              <div className={homeStyles.cardText}>
                DISC measures what people see (external behavior), not why you do it (motivation). Two people may show
                High Dominance for different reasons, but the observable behavior is similar.
              </div>
            </div>
            <div className={homeStyles.card}>
              <div className={homeStyles.cardTitle}>What to optimize first</div>
              <div className={homeStyles.cardText}>
                Understanding your primary pace (fast vs slow) and priority (task vs people) improves team communication
                and reduces workplace friction.
              </div>
            </div>
          </div>
        </section>
        ...
        <section className={homeStyles.section}>
          <h2 className={homeStyles.sectionTitle}>The Four Behavioral Dimensions Explained</h2>
          <div className={homeStyles.grid} aria-label="Dimensions">
            {discDimensions.map((d) => (
              <div key={d.title} className={homeStyles.listCard}>
                <div className={homeStyles.cardTitle}>
                  <span aria-hidden="true">{d.icon}</span> {d.title}
                </div>
                ...
                <ul className={homeStyles.list}>
                  ...
                  <li>
                    <strong>Keywords:</strong> {d.facets}
                  </li>
                </ul>
              </div>
            ))}
        ...
        <section className={homeStyles.section}>
          <h2 className={homeStyles.sectionTitle}>15 Strategies to Leverage Your DISC Style</h2>
          <div className={homeStyles.grid} aria-label="Strategies">
            {discStrategies.map((s, idx) => (
              <article key={s.title} className={homeStyles.methodCard}>
                <div className={homeStyles.methodIcon} aria-hidden="true">
                  {mbtiApplicationIcons[idx] ?? "🧩"}
                </div>
        ...
        <section className={homeStyles.section}>
          <h2 className={homeStyles.sectionTitle}>Extra Checklist (Workplace Application)</h2>
          <div className={homeStyles.listCard}>
            <ul className={homeStyles.list}>
              {discChecklist.map((c) => (
                <li key={c}>{c}</li>
    ...
    return (
      <>
        ...
        <section className={homeStyles.hero}>
          ...
          <div className={homeStyles.badges} aria-label="Highlights">
            {(((get(`${infoBaseKey}.badges`) as string[] | undefined) ?? enneagramBadges) as string[]).map((b) => (
              <span key={b} className={homeStyles.badge}>
                {b}
              </span>
            ))}
          ...
          <div className={homeStyles.cta}>
            <h2 className={homeStyles.ctaTitle}>
              {i18nStr(`${infoBaseKey}.cta.title`, "Start with your core type discovery")}
            </h2>
            <p className={homeStyles.ctaText}>
              {i18nStr(
            ...
            <Link to={startHref} className={homeStyles.ctaButton}>
              {i18nStr(`${infoBaseKey}.cta.button`, "🧪 Take the Enneagram Assessment")}
            </Link>
          </div>
        </section>

        <section className={homeStyles.section}>
          <h2 className={homeStyles.sectionTitle}>Can your type change?</h2>
          <div className={homeStyles.snippet} role="note" aria-label="Key takeaway">
            Your core type remains constant—it forms early as a survival strategy. What changes is your health level
            (how balanced you are) and how flexibly you access other patterns.
          </div>

          <div className={homeStyles.cards}>
            <div className={homeStyles.card}>
              <div className={homeStyles.cardTitle}>Type vs. Behavior</div>
              <div className={homeStyles.cardText}>
                Two people may act identically (e.g., workaholics) for opposite reasons. Enneagram reveals the why behind
                the what.
              </div>
            </div>
            <div className={homeStyles.card}>
        ...
        <section className={homeStyles.section}>
          <h2 className={homeStyles.sectionTitle}>The Nine Types Explained by Triads</h2>
          <div className={homeStyles.grid} aria-label="Triads">
            {enneagramTriads.map((triad) => (
              <div key={triad.title} className={homeStyles.listCard}>
                <div className={homeStyles.cardTitle}>{triad.title}</div>
                <div className={homeStyles.cardText}>
                  <strong>Core emotion:</strong> {triad.coreEmotion}
                </div>
                <ul className={homeStyles.list}>
                  {triad.types.map((t) => (
                    <li key={t.name}>
                      ...
                      <div>
                        <strong>Core fear:</strong> {t.fear}
                      </div>
                      <div>
                        <strong>Core desire:</strong> {t.desire}
                      </div>
                      <div>
                        <strong>Pattern:</strong> {t.pattern}
                      </div>
                      <div>
                        <strong>At best:</strong> {t.best}
                      </div>
                      <div>
                        <strong>At worst:</strong> {t.worst}
                      </div>
                    </li>
                  ))}
                </ul>
        ...
        <section className={homeStyles.section}>
          <h2 className={homeStyles.sectionTitle}>15 Paths to Psychological Integration</h2>
          <div className={homeStyles.grid} aria-label="Integration paths">
            {enneagramPaths.map((s, idx) => (
              <article key={s.title} className={homeStyles.methodCard}>
                <div className={homeStyles.methodIcon} aria-hidden="true">
                  {mbtiApplicationIcons[idx] ?? "🧩"}
                </div>
        ...
        <section className={homeStyles.section}>
          <h2 className={homeStyles.sectionTitle}>Extra Checklist (Deep Work)</h2>
          <div className={homeStyles.listCard}>
            <ul className={homeStyles.list}>
              {enneagramChecklist.map((c) => (
                <li key={c}>{c}</li>
              ))}
            </ul>
            <Link to={startHref} className={homeStyles.secondaryButton}>
    ...
    return (
      <>
        ...
        <section className={homeStyles.hero}>
          ...
          <div className={homeStyles.badges} aria-label="Highlights">
            {(((get(`${infoBaseKey}.badges`) as string[] | undefined) ?? hollandBadges) as string[]).map((b) => (
              <span key={b} className={homeStyles.badge}>
                {b}
              </span>
            ))}
          ...
          <div className={homeStyles.cta}>
            <h2 className={homeStyles.ctaTitle}>
              {i18nStr(`${infoBaseKey}.cta.title`, "Start with your vocational profile")}
            </h2>
            <p className={homeStyles.ctaText}>
              {i18nStr(
                `${infoBaseKey}.cta.text`,
            ...
            <Link to={startHref} className={homeStyles.ctaButton}>
              {i18nStr(`${infoBaseKey}.cta.button`, "🧪 Take the RIASEC Assessment")}
            </Link>
          </div>
        </section>

        <section className={homeStyles.section}>
          <h2 className={homeStyles.sectionTitle}>Is career destiny fixed?</h2>
          <div className={homeStyles.snippet} role="note" aria-label="Key takeaway">
            Interests stabilize by age 25–30, but skills can be developed. The goal is finding the intersection: where
            your natural interests meet marketable abilities.
          </div>

          <div className={homeStyles.cards}>
            <div className={homeStyles.card}>
              <div className={homeStyles.cardTitle}>Congruence = Satisfaction</div>
              <div className={homeStyles.cardText}>
                When your interests match your work environment, satisfaction rises and turnover drops. Mismatch creates
                daily friction that leads to burnout.
              </div>
            </div>
            <div className={homeStyles.card}>
              <div className={homeStyles.cardTitle}>What to optimize first</div>
              <div className={homeStyles.cardText}>
                Identify your 3-letter code (e.g., ASE, RIC, SEC). The first letter is your anchor; the third often
                shows avoidance areas (what drains you).
              </div>
            </div>
          </div>
        </section>
        ...
        <section className={homeStyles.section}>
          <h2 className={homeStyles.sectionTitle}>The Six Interest Types Explained</h2>
          <div className={homeStyles.grid} aria-label="RIASEC types">
            {hollandTypes.map((t) => (
              <div key={t.code} className={homeStyles.listCard}>
                <div className={homeStyles.cardTitle}>
                  <span aria-hidden="true">{t.icon}</span> {t.code} — {t.name}
                </div>
                <div className={homeStyles.cardText}>{t.summary}</div>
                <ul className={homeStyles.list}>
                  <li>
                  ...
                  <li>
                    <strong>Ideal environments:</strong> {t.environments}
                  </li>
                  <li>
                    <strong>Sample careers:</strong> {t.careers}
                  </li>
                  <li>
                    <strong>Avoid:</strong> {t.avoid}
                  </li>
                </ul>
              </div>
            ))}
        ...
        <section className={homeStyles.section}>
          <h2 className={homeStyles.sectionTitle}>15 Strategies for Career Congruence</h2>
          <div className={homeStyles.grid} aria-label="Strategies">
            {hollandStrategies.map((s, idx) => (
              <article key={s.title} className={homeStyles.methodCard}>
                <div className={homeStyles.methodIcon} aria-hidden="true">
                  {mbtiApplicationIcons[idx] ?? "🧩"}
                </div>
        ...
        <section className={homeStyles.section}>
          <h2 className={homeStyles.sectionTitle}>Extra Checklist (Career Clarity)</h2>
          <div className={homeStyles.listCard}>
            <ul className={homeStyles.list}>
              {hollandChecklist.map((c) => (
                <li key={c}>{c}</li>
              ))}
            </ul>
            <Link to={startHref} className={homeStyles.secondaryButton}>
    ...
    return (
      <>
        ...
        <section className={homeStyles.hero}>
          ...
          <div className={homeStyles.badges} aria-label="Highlights">
            {(((get(`${infoBaseKey}.badges`) as string[] | undefined) ?? eqBadges) as string[]).map((b) => (
              <span key={b} className={homeStyles.badge}>
                {b}
              </span>
            ))}
          ...
          <div className={homeStyles.cta}>
            <h2 className={homeStyles.ctaTitle}>
              {i18nStr(`${infoBaseKey}.cta.title`, "Start with your emotional profile")}
            </h2>
            <p className={homeStyles.ctaText}>
              {i18nStr(`${infoBaseKey}.cta.text`, "25 questions • 4 branches • skill-based scoring • development plan")}
            </p>
            <Link to={startHref} className={homeStyles.ctaButton}>
              {i18nStr(`${infoBaseKey}.cta.button`, "🧪 Take the EQ Assessment")}
            </Link>
          </div>
        </section>

        <section className={homeStyles.section}>
          <h2 className={homeStyles.sectionTitle}>Can EQ be learned?</h2>
          <div className={homeStyles.snippet} role="note" aria-label="Key takeaway">
            Yes—unlike personality types, emotional intelligence is a cognitive skill set. With deliberate practice, EQ
            can improve noticeably within months.
          </div>

          <div className={homeStyles.cards}>
            <div className={homeStyles.card}>
              <div className={homeStyles.cardTitle}>EQ vs. Personality</div>
              <div className={homeStyles.cardText}>
                An introvert can have high EQ. A conscientious person can have low EQ. EQ measures competence, not
                preference.
              </div>
            </div>
            <div className={homeStyles.card}>
              <div className={homeStyles.cardTitle}>What drives success</div>
              <div className={homeStyles.cardText}>
                EQ supports better relationships, decision-making, and leadership. IQ can open doors; EQ helps you grow
                inside the role.
              </div>
            </div>
          </div>
        ...
        <section className={homeStyles.section}>
          <h2 className={homeStyles.sectionTitle}>The Four Branches of Emotional Intelligence</h2>
          <div className={homeStyles.grid} aria-label="EQ branches">
            {eqBranches.map((b) => (
              <div key={b.title} className={homeStyles.listCard}>
                <div className={homeStyles.cardTitle}>
                  <span aria-hidden="true">{b.icon}</span> {b.title}
                </div>
                <div className={homeStyles.cardText}>{b.desc}</div>
                <ul className={homeStyles.list}>
                  <li>
                    <strong>High:</strong> {b.high}
                  </li>
                  <li>
                    <strong>Low:</strong> {b.low}
                  </li>
                </ul>
              </div>
            ))}
        ...
        <section className={homeStyles.section}>
          <h2 className={homeStyles.sectionTitle}>15 Strategies to Develop Your EQ</h2>
          <div className={homeStyles.grid} aria-label="EQ strategies">
            {eqStrategies.map((s, idx) => (
              <article key={s.title} className={homeStyles.methodCard}>
                <div className={homeStyles.methodIcon} aria-hidden="true">
                  {mbtiApplicationIcons[idx] ?? "🧩"}
                </div>
        ...
        <section className={homeStyles.section}>
          <h2 className={homeStyles.sectionTitle}>Extra Checklist</h2>
          <div className={homeStyles.listCard}>
            <ul className={homeStyles.list}>
              {eqChecklist.map((c) => (
                <li key={c}>{c}</li>
    ...
    return (
      <>
        ...
        <section className={homeStyles.hero}>
          ...
          <div className={homeStyles.badges} aria-label="Highlights">
            {(((get(`${infoBaseKey}.badges`) as string[] | undefined) ?? loveBadges) as string[]).map((b) => (
              <span key={b} className={homeStyles.badge}>
                {b}
              </span>
            ))}
          ...
          <div className={homeStyles.cta}>
            <h2 className={homeStyles.ctaTitle}>{i18nStr(`${infoBaseKey}.cta.title`, "Start with your love profile")}</h2>
            <p className={homeStyles.ctaText}>
              {i18nStr(
                `${infoBaseKey}.cta.text`,
            ...
            <Link to={startHref} className={homeStyles.ctaButton}>
              {i18nStr(`${infoBaseKey}.cta.button`, "🧪 Take the Love Languages Assessment")}
            </Link>
          </div>
        </section>

        <section className={homeStyles.section}>
          <h2 className={homeStyles.sectionTitle}>Why do relationships fail?</h2>
          <div className={homeStyles.snippet} role="note" aria-label="Key takeaway">
            Not because love ends, but because miscommunication begins. You give what you want to receive, while your
            partner needs something else. Languages bridge this gap.
          </div>

          <div className={homeStyles.cards}>
            <div className={homeStyles.card}>
              <div className={homeStyles.cardTitle}>Universal but prioritized</div>
              <div className={homeStyles.cardText}>
                Everyone appreciates all five, but each person has a primary tank that fills fastest and drains slowest.
                Secondary languages help; speaking the primary transforms.
              </div>
            </div>
            <div className={homeStyles.card}>
              <div className={homeStyles.cardTitle}>Beyond romance</div>
              <div className={homeStyles.cardText}>
                Children have love languages. Teams have appreciation languages. Understanding yourself prevents
                resentment; understanding others prevents neglect.
              </div>
            </div>
          </div>
        </section>
        ...
        <section className={homeStyles.section}>
          <h2 className={homeStyles.sectionTitle}>The Five Love Languages Explained</h2>
          <div className={homeStyles.grid} aria-label="Love languages">
            {loveLanguages.map((l) => (
              <div key={l.title} className={homeStyles.listCard}>
                <div className={homeStyles.cardTitle}>
                  <span aria-hidden="true">{l.icon}</span> {l.title}
                </div>
                <div className={homeStyles.cardText}>{l.summary}</div>
                <ul className={homeStyles.list}>
                  <li>
                    <strong>Speakers need:</strong> {l.need}
                  </li>
                  <li>
                    <strong>Speakers feel:</strong> {l.feel}
                  </li>
                  <li>
                    <strong>Danger zone:</strong> {l.danger}
                  </li>
                </ul>
              </div>
            ))}
        ...
        <section className={homeStyles.section}>
          <h2 className={homeStyles.sectionTitle}>15 Applications for Deeper Connection</h2>
          <div className={homeStyles.grid} aria-label="Applications">
            {loveApplications.map((s, idx) => (
              <article key={s.title} className={homeStyles.methodCard}>
                <div className={homeStyles.methodIcon} aria-hidden="true">
                  {mbtiApplicationIcons[idx] ?? "🧩"}
                </div>
    ...
    return (
      <>
        ...
        <section className={homeStyles.hero}>
          ...
          <div className={homeStyles.badges} aria-label="Highlights">
            {(((get(`${infoBaseKey}.badges`) as string[] | undefined) ?? attachmentBadges) as string[]).map((b) => (
              <span key={b} className={homeStyles.badge}>
                {b}
              </span>
            ))}
          ...
          <div className={homeStyles.cta}>
            <h2 className={homeStyles.ctaTitle}>
              {i18nStr(`${infoBaseKey}.cta.title`, "Start with your attachment profile")}
            </h2>
            <p className={homeStyles.ctaText}>
              {i18nStr(`${infoBaseKey}.cta.text`, "20 questions • 4 styles • anxiety/avoidance axes • healing strategies")}
            </p>
            <Link to={startHref} className={homeStyles.ctaButton}>
              {i18nStr(`${infoBaseKey}.cta.button`, "🧪 Take the Attachment Assessment")}
            </Link>
          </div>
        </section>

        <section className={homeStyles.section}>
          <h2 className={homeStyles.sectionTitle}>Is attachment destiny?</h2>
          <div className={homeStyles.snippet} role="note" aria-label="Key takeaway">
            Attachment is partly stable and partly changeable through earned security. Your childhood template predicts
            but doesn’t condemn: awareness + corrective experiences = transformation.
          </div>

          <div className={homeStyles.cards}>
            <div className={homeStyles.card}>
              <div className={homeStyles.cardTitle}>The internal working model</div>
              <div className={homeStyles.cardText}>
                Attachment forms a nervous-system script: Are others reliable? Am I worthy of love? This script runs on
                autopilot until examined.
              </div>
            </div>
            <div className={homeStyles.card}>
              <div className={homeStyles.cardTitle}>Beyond romance</div>
              <div className={homeStyles.cardText}>
                Attachment affects friendships, parenting, and even workplace dynamics (how you relate to bosses can
                echo early caregiver dynamics).
              </div>
            </div>
          </div>
        </section>
        ...
        <section className={homeStyles.section}>
          <h2 className={homeStyles.sectionTitle}>The Four Attachment Styles Explained</h2>
          <div className={homeStyles.grid} aria-label="Attachment styles">
            {attachmentStyles.map((s) => (
              <div key={s.title} className={homeStyles.listCard}>
                <div className={homeStyles.cardTitle}>
                  <span aria-hidden="true">{s.icon}</span> {s.title}
                </div>
                <div className={homeStyles.cardText}>{s.summary}</div>
                <ul className={homeStyles.list}>
                  <li>
                    <strong>Signs:</strong> {s.signs}
                  </li>
                  <li>
                    <strong>Childhood:</strong> {s.childhood}
                  </li>
                  <li>
                    <strong>Mantra:</strong> {s.mantra}
                  </li>
                </ul>
              </div>
            ))}
        ...
        <section className={homeStyles.section}>
          <h2 className={homeStyles.sectionTitle}>15 Paths to Earned Security</h2>
          <div className={homeStyles.grid} aria-label="Earned security paths">
            {attachmentPaths.map((p, idx) => (
              <article key={p.title} className={homeStyles.methodCard}>
                <div className={homeStyles.methodIcon} aria-hidden="true">
                  {mbtiApplicationIcons[idx] ?? "🧩"}
                </div>
                <div className={homeStyles.methodTitle}>{p.title}</div>
                <div className={homeStyles.methodDesc}>{p.text}</div>
                <div className={homeStyles.methodBenefits}>
      ...
      <section className={styles.wrapper}>
        <div className={styles.header}>
          <h1 className={styles.title}>
            ...
            {assessment.name} (Info)
          </h1>
          <p className={styles.subtitle}>Hadi saf7a dyal l-ma3loumat.</p>
        </div>

        <div className={styles.card}>
          <div className={styles.cardTitle}>Ready to take the test?</div>
          <p className={styles.cardText}>
            Saf7at l-ikhtibar mوجدa daba كهيكلة فقط. Ghadi tji b الأسئلة و scoring من بعد.
          </p>
          <Link className={styles.primaryLink} to={startHref}>
            Go to {assessment.name} Test →
          </Link>
        </div>

        <div className={styles.section}>
          <h2 className={styles.sectionTitle}>Other assessments</h2>
            ...
            {assessments
              ...
              .map((a) => (
                <Link key={a.id} to={a.id === "iq" ? "/" : `/assessments/${a.id}`} className={styles.gridCard}>
                  ...
                  <div className={styles.gridDesc}>Info page → start test</div>
                </Link>
              ))}
          </div>
        </div>
